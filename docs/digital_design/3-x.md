...
更多的内容可以看 **[MinJoker 的数逻笔记](https://note.minjoker.top/cs/system/digital_logic/note2/#_7){target="_blank"}** 和 **[xxjj 的计组笔记](https://xuan-insr.github.io/computer_organization/3_arithmetic/#311-1-bit-alu){target="_blank"}**（数逻中最多了解到超前进位加法器即可）。
